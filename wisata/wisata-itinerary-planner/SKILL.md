...
- **Setiap kota disusun independen** (berubah 2026-08-19, sebelumnya wajib cek kota sebelumnya) — TIDAK perlu baca/menyambung jadwal transportasi dari kota sebelum atau sesudahnya dalam rangkaian multi-kota. Pakai default jam kedatangan (17:00) & kepulangan (13:00) di poin 1 langsung tanpa tanya, KECUALI pengguna sudah kasih jadwal aktual sendiri (jam city sebelumnya, nomor kereta/pesawat, dll) — kalau info aktual ada, pakai itu, jangan timpa dengan default.
...
2. Untuk destinasi baru: riset dari nol seperti biasa (web_search, image_search), tetap ikuti semua kriteria poin 1-9 (makanan, tempat wisata, fisik/lutut, transportasi, foto/referensi).
...
4. Urutkan destinasi terpilih berdasarkan searah/berdekatan (poin 5) DAN realistis muat dalam jendela waktu yang diberikan. Kalau tidak semua muat, sebutkan eksplisit mana yang dikorbankan/dipotong dan kenapa — jangan memaksakan jadwal yang tidak masuk akal.
